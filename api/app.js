...
const renderHomePage = (mainEl, data) => {
  ...
  <h1>Home</h1>
  <h3>Current Weather in: ${data.timezone}</h3>
  <h4>Current Date: ${date.toLocaleDateString(`fr`)}</h4>
  <h5>Temperature: ${data.current.temp}°C</h5>
  <h5>Feels Like: ${data.current.feels_like}°C</h5>
  <h5>Win Speed ${data.current.wind_speed}</h5>
  <img src="http://openweathermap.org/img/wn/${
    data.current.weather[0].icon
  }@2x.png" alt="">
  <h5>${data.current.weather[0].description}</h5>
  <h5>Humdity: ${data.current.humidity}</h5>
  ...
  for (let el of data.daily) {
    ...
    dailyHTML += `
    <div class="day-box">
    <h5>Date:${dailyDate.toLocaleDateString("fr")}</h5>
    <h5>Min Temp:${el.temp.min}</h5>
    <h5>Max Temp:${el.temp.max}</h5>
    <img src="http://openweathermap.org/img/wn/${
      el.weather[0].icon
    }@2x.png" alt="" width="50px"
    height="50px">
    <h5>Description: ${el.weather[0].description}</h5>
</div>
    `;
  }
...
const renderAboutPage = (mainEl, data) => {
  mainEl.innerHTML = "";
  mainEl.innerHTML = `<h1>Welcome to the about page</h1>`;
};

homeBtn.addEventListener("click", () => {
  renderHomePage(mainEl, dummyData);
});
